    ...
    <div id="content-wrapper" class="d-flex flex-column">
      ...
      <div id="content">
        ...
        <div class="container-fluid">
          ...
          <p class="mb-4">■	현재 진행중인 예약 상황을 조회 할 수있다. ■	예약을 취소가능하다.(판매자의 규정내에 취소시) 
            ■	예약 변경시에는 취소후 재 예약을 해야한다. ■	이전에 예약한 리스트를 볼 수 있다.
            ■	예약 취소 리스트를 볼 수 있다.  ■	예약리스트를 날짜별로 조회할 수 있다.
            ■	예약한 차량의 반납을 할 수 있다.</p>
